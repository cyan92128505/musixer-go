...
func NewSnippetApiWithBasePath(basePath string) *SnippetApi {
	configuration := NewConfiguration()
 ...
 */
func (a SnippetApi) TrackSnippetGetGet(trackId string, format string, callback string) (*InlineResponse20010, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/track.snippet.get"

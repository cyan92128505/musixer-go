...
type TrackSecondaryGenresMusicGenre struct {

	//
	MusicGenreVanity string `json:"music_genre_vanity,omitempty"`

	//
	MusicGenreNameExtended string `json:"music_genre_name_extended,omitempty"`

	//
	MusicGenreParentId float32 `json:"music_genre_parent_id,omitempty"`

	//
	MusicGenreName string `json:"music_genre_name,omitempty"`

	//
	MusicGenreId float32 `json:"music_genre_id,omitempty"`
}

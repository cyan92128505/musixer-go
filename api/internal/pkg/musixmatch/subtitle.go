...
type Subtitle struct {
	...
	//
	SubtitleBody string `json:"subtitle_body,omitempty"`
	...
	//
	SubtitleLanguageDescription string `json:"subtitle_language_description,omitempty"`
	...
	//
	SubtitleLength float32 `json:"subtitle_length,omitempty"`

...
func NewAlbumApiWithBasePath(basePath string) *AlbumApi {
	configuration := NewConfiguration()
 ...
 */
func (a AlbumApi) AlbumGetGet(albumId string, format string, callback string) (*InlineResponse200, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/album.get"
 ...
 * @param format output format: json, jsonp, xml.
 * @param callback jsonp callback
 * @param sReleaseDate Sort by release date (asc|desc)
 * @param gAlbumName Group by Album Name
 ...
 */
func (a AlbumApi) ArtistAlbumsGetGet(artistId string, format string, callback string, sReleaseDate string, gAlbumName string, pageSize float32, page float32) (*InlineResponse2002, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/artist.albums.get"
	...
	queryParams.Add("s_release_date", a.Configuration.APIClient.ParameterToString(sReleaseDate, ""))
	queryParams.Add("g_album_name", a.Configuration.APIClient.ParameterToString(gAlbumName, ""))

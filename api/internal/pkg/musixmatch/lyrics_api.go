...
func NewLyricsApiWithBasePath(basePath string) *LyricsApi {
	configuration := NewConfiguration()
 ...
 */
func (a LyricsApi) MatcherLyricsGetGet(format string, callback string, qTrack string, qArtist string) (*InlineResponse2007, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/matcher.lyrics.get"
 ...
 * @return *InlineResponse2007
 */
func (a LyricsApi) TrackLyricsGetGet(trackId string, format string, callback string) (*InlineResponse2007, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/track.lyrics.get"

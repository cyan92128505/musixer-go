...
type Lyrics struct {
	...
	//
	PixelTrackingUrl string `json:"pixel_tracking_url,omitempty"`

	PublisherList []string `json:"publisher_list,omitempty"`

	//
	LyricsLanguageDescription string `json:"lyrics_language_description,omitempty"`
	...
	//
	LyricsCopyright string `json:"lyrics_copyright,omitempty"`

	//
	HtmlTrackingUrl string `json:"html_tracking_url,omitempty"`

	//
	LyricsLanguage string `json:"lyrics_language,omitempty"`

	//
	ScriptTrackingUrl string `json:"script_tracking_url,omitempty"`
	...
	//
	CanEdit float32 `json:"can_edit,omitempty"`

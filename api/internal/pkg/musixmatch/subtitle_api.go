...
func NewSubtitleApi() *SubtitleApi {
...
func NewSubtitleApiWithBasePath(basePath string) *SubtitleApi {
	configuration := NewConfiguration()
 ...
 * @param fSubtitleLength Filter by subtitle length in seconds
 * @param fSubtitleLengthMaxDeviation Max deviation for a subtitle length in seconds
 * @return *InlineResponse2008
 */
func (a SubtitleApi) MatcherSubtitleGetGet(format string, callback string, qTrack string, qArtist string, fSubtitleLength float32, fSubtitleLengthMaxDeviation float32) (*InlineResponse2008, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/matcher.subtitle.get"
	...
	queryParams.Add("f_subtitle_length", a.Configuration.APIClient.ParameterToString(fSubtitleLength, ""))
	queryParams.Add("f_subtitle_length_max_deviation", a.Configuration.APIClient.ParameterToString(fSubtitleLengthMaxDeviation, ""))
 ...
 * @return *InlineResponse2008
 */
func (a SubtitleApi) TrackSubtitleGetGet(trackId string, format string, callback string) (*InlineResponse2008, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/track.subtitle.get"
